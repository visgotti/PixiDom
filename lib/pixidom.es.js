Number.isNaN = Number.isNaN || function(m) {
...
const k = function(m) {
  ...
  try {
    const e = m.toString().slice(-2);
    if (e.charAt(1) === "%") {
      if (t = parseInt(m.slice(0, -1)), Number.isNaN(t))
      ...
      if (t = parseInt(m.slice(0, -2)), Number.isNaN(t))
...
function R(m, t, e) {
  return m <= t ? t : m >= e ? e : m;
}
function H(m) {
  return typeof m == "string" && m[0] === "#" && (m = m.substr(1)), parseInt(m, 16);
}
function G(m, t) {
  if (!m.parent && !(t != null && t.parent)) throw new Error("No parent");
  const e = (t == null ? void 0 : t.parent) || m.parent, n = () => m.x = e.width / 2 - m.width / 2, i = () => m.y = e.height / 2 - m.height / 2;
  t != null && t.axis ? t.axis === "x" ? n() : t.axis === "y" && i() : (n(), i());
}
function U(m) {
  return class extends m {
    ...
    changeStateIndex(e) {
      const n = this.currentStateIndex = e;
      this.textStates[n] && (super.change(this.textStates[n]), this.currentStateIndex = e);
    }
    registerHandlers() {
    ...
    onPaste(e) {
      const n = e.clipboardData ? e.clipboardData.getData("text/plain") : this.copiedText, i = super.replaceSelectedWith(n);
      i !== null && this.addState(i);
    }
    onCopy(e) {
      e.preventDefault();
      const n = super.getSelectedChars();
      e.clipboardData && e.clipboardData.setData("text/plain", n), this.copiedText = n;
    }
    onCut(e) {
      e.preventDefault();
      const n = super.getSelectedChars();
    ...
    onKeyDown(e) {
      var r, f;
      const n = e.keyCode ?? e.which, i = e.code;
      if (this.submitKeyCodes.includes(n) || this.submitKeyCodes.includes(i))
        super.submit();
      else if (n == 37 || i === "ArrowLeft") {
        const w = (r = super.getSelectedRange()) == null ? void 0 : r.indexes;
        w ? super.setCursor(w.start) : super.moveCursor(-1);
      } else if (n == 39 || i === "ArrowRight") {
        const w = (f = super.getSelectedRange()) == null ? void 0 : f.indexes;
        w ? super.setCursor(w.end) : super.moveCursor(1);
      } else if (n == 8 || i === "Backspace")
        super.getSelectedRange() ? super.replaceSelectedWith("") : super.removeLeftOfCursor();
      else if (n == 46 || i === "Delete")
        super.getSelectedRange() ? super.replaceSelectedWith("") : super.removeRightOfCursor();
      else if (e.ctrlKey || e.metaKey)
        if (n == 90 || i === "KeyZ") {
          const w = e.shiftKey ? 1 : -1;
          this.changeStateIndex(w);
        } else (n == 65 || i === "KeyA") && (e.preventDefault(), super.selectAll());
    }
    onKeyPress(e) {
      const n = e.keyCode ?? e.which, i = e.code;
      if (!(this.submitKeyCodes.includes(n) || this.submitKeyCodes.includes(i) || this.ignoreKeys.includes(n) || this.ignoreKeys.includes(i) || e.ctrlKey || e.metaKey))
        if (n != null) {
          const r = String.fromCharCode(n);
          r && (e.preventDefault(), super.replaceSelectedWith(r));
        } else i && ([
          "Backspace",
          "Tab",
          "Alt",
          ...
          "F11",
          "F12"
        ].includes(i) ? (e.preventDefault(), super.replaceSelectedWith("")) : e.key && e.key.length === 1 && (e.preventDefault(), super.replaceSelectedWith(e.key)), i === "Backspace" || (i === "Delete" ? (e.preventDefault(), super.replaceSelectedWith("")) : i && i.length === 1 && !e.ctrlKey && !e.metaKey && (e.preventDefault(), super.replaceSelectedWith(i))));
    }
    addState(e) {
...
class j extends PIXI.Container {
  ...
  updateStyle(t) {
    for (const e in t)
      if (K.includes(e)) {
        const n = k(t[e]);
        if (n.error)
          throw new Error(`Error for passed in style: ${e}, ${n.error}`);
        this.styleOptions[e] = n;
      } else
  ...
  redrawCursor() {
    ...
    const { value: e, type: n } = this.styleOptions.cursorHeight, i = n === "pixel" ? e : Math.round(this.textbox.height * (e / 100)), r = Math.min(this.textbox.height, i), w = (Math.max(this.textbox.height, i) - r) / 2, p = Math.floor(w), x = Math.ceil(w);
  ...
  redrawText() {
    ...
    const e = this.getCursorXFromIndex(this.dragIndexEnd), { value: n, type: i } = this.styleOptions.width, r = window.innerWidth, f = i === "pixel" ? n : r * (n / 100);
    ...
    for (let w = 0; w < this.textSprite.children.length; w++) {
      const p = this.textSprite.children[w];
      if (t) {
        const { indexes: x } = t, { start: y, end: b } = x;
        if (w >= y && w < b) {
  ...
  redrawTextbox() {
    ...
    const n = window.innerWidth, i = window.innerHeight, r = e === "pixel" ? t : i * (t / 100);
    ({ value: t, type: e } = this.styleOptions.width);
    const f = e === "pixel" ? t : n * (t / 100), w = this.getSelectedRange();
    if (this.textbox.drawRect(0, 0, f, r), this.textbox.endFill(), w) {
      let p = w.x.start - this.overflowOffsetX;
      const x = w.x.end - this.overflowOffsetX;
  ...
  getCursorIndexFromX(t) {
    ...
    for (let e = 0; e < this.textSprite.children.length; e++) {
      const n = this.textSprite.children[e];
      if (n.x + n.width > t)
        return n.x + n.width / 2 < t ? e + 1 : e;
    }
  ...
  getSelectedChars() {
    const t = this.getSelectedRange();
    if (!t) return "";
    const { indexes: e } = t, { start: n, end: i } = e;
    return this.text.substr(n, i - n);
  }
  replaceSelectedWith(t) {
    const e = t.split(""), n = e.length;
    this.text;
    const i = this.text.split("");
    let r, f;
    const w = this.getSelectedRangeIndexes();
    w ? { start: r, end: f } = w : r = f = this.cursorIndex;
    const p = f - r;
    return i.splice(r, p, ...e), this._change(i.join("")) ? (this.cursorIndex = r + n, this.clearRange(), this.redraw(), this.text) : this.text;
  }
  ...
  getSelectedRange() {
    ...
    if (t === e) return null;
    const n = this.getCursorXFromIndex(t), i = this.getCursorXFromIndex(e);
    return {
  ...
  change(t) {
    const e = this._change(t);
    return e && this.redrawText(), e;
  }
...
class T extends PIXI.Container {
  ...
  __dragmove(t) {
    if (this._dragmoveHandler(t), this.hasSwipeHandler) {
      const e = Date.now(), n = e - this.lastDragCheckTs;
      this.lastDragCheckTs = e, this.curDragSwiperCheckIterationDuration += n;
  ...
  __dragend(t) {
    if (this.inDrag = !1, this._dragendHandler(t), this.hasSwipeHandler) {
      ...
      if (e) {
        const n = Math.max(10, this.curDragSwiperCheckIterationDuration), i = Math.min(this.maxSwipeTimeout, n), r = this.ifDragEndEmitSwipeDistance / (i + 100 / 15) * 10;
  ...
  handleSwipeFinish(t) {
    if (this.hasSwipeHandler) {
      const e = this.swipeStartY - t, n = Math.max(Date.now() - this.swipeStartTs, 1);
      if (n < this.maxSwipeTimeout && Math.abs(e) > this.minSwipeDistance) {
        const i = e / (n + 6.666666666666667) * 10;
        if (Math.abs(i) > 10) {
...
function Y() {
  ...
  var m = {
    ...
    easeInElastic: function(t, e, n, i) {
      var r = n - e, f, w, p;
      return p = 1.70158, w = 0, f = r, t === 0 ? e : (t /= i) === 1 ? e + r : (w || (w = i * 0.3), f < Math.abs(r) ? (f = r, p = w / 4) : p = w / (2 * Math.PI) * Math.asin(r / f), -(f * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * i - p) * (2 * Math.PI) / w)) + e);
    },
    easeOutElastic: function(t, e, n, i) {
      var r = n - e, f, w, p;
      return p = 1.70158, w = 0, f = r, t === 0 ? e : (t /= i) === 1 ? e + r : (w || (w = i * 0.3), f < Math.abs(r) ? (f = r, p = w / 4) : p = w / (2 * Math.PI) * Math.asin(r / f), f * Math.pow(2, -10 * t) * Math.sin((t * i - p) * (2 * Math.PI) / w) + r + e);
    },
    easeInOutElastic: function(t, e, n, i) {
      var r = n - e, f, w, p;
      return p = 1.70158, w = 0, f = r, t === 0 ? e : (t /= i / 2) === 2 ? e + r : (w || (w = i * (0.3 * 1.5)), f < Math.abs(r) ? (f = r, p = w / 4) : p = w / (2 * Math.PI) * Math.asin(r / f), t < 1 ? -0.5 * (f * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * i - p) * (2 * Math.PI) / w)) + e : f * Math.pow(2, -10 * (t -= 1)) * Math.sin((t * i - p) * (2 * Math.PI) / w) * 0.5 + r + e);
    },
    ...
    easeInBounce: function(t, e, n, i) {
      var r = n - e, f;
      return f = m.easeOutBounce(i - t, 0, r, i), r - f + e;
    },
    ...
    easeInOutBounce: function(t, e, n, i) {
      var r = n - e, f;
      return t < i / 2 ? (f = m.easeInBounce(t * 2, 0, r, i), f * 0.5 + e) : (f = m.easeOutBounce(t * 2 - i, 0, r, i), f * 0.5 + r * 0.5 + e);
    }
  };
  return E = m, E;
}
var Q = Y();
const A = /* @__PURE__ */ V(Q);
class z extends T {
  constructor(t, e) {
    super(), this.scrolling = !1, this.scrollList = t, this.options = e || {}, this.bg = new PIXI.Graphics(), this.addChild(this.bg), this.scroller = new $(this, e.scrollerOptions), this.addChild(this.scroller), this.scroller.y = 0, this.redraw(), this.registerScrollerEvents();
  }
  resizeScrollBar(t, e) {
  }
  get visibleLength() {
  ...
  setScrollPercent(t) {
    console.error("set", t);
    const n = (this.visibleLength - this.scroller.height) * t;
    this.scroller.y = n;
  }
  registerScrollerEvents() {
    this.onHeldDown((t) => {
      ...
      let n = -1;
      e < this.scroller.y ? n = e : e > this.scroller.y + this.scroller.height && (n = e - this.scroller.height), n >= 0 && !this.scrolling && (this.scroller.y = R(n, 0, this.visibleLength - this.scroller.height), this.emitScroll());
      ...
      t.stopPropagation();
      const e = t.data.originalEvent.movementY, n = t.data.global.y, i = this.getGlobalPosition(), r = this.scroller.y + i.y;
      let f = 0;
      n > r + this.scroller.height ? f = n - (r + this.scroller.height) : n < r && (f = n - r), this.scroller.y = R(this.scroller.y + e + f, 0, this.visibleLength - this.scroller.height), this.emitScroll();
    });
  }
  emitScroll() {
...
class Z extends PIXI.Container {
  ...
  _containsPoint(t, e) {
    e = this.toLocal(e);
    const n = 0, i = this.__width, r = t.y - this.currentScroll, f = r + t.height;
    return n <= e.x && e.x <= i && r <= e.y && e.y <= f;
  }
  resize(t, e) {
  ...
  adjustVisibility(t, e = !1) {
    ...
    for (let i = 0; i < this.options.length; i++) {
      const r = this.options[i], f = r.y + r.height + this.performanceOptions.visibilityBuffer >= this.currentScroll, w = this.__height + this.currentScroll >= r.y - this.performanceOptions.visibilityBuffer, p = r.visible;
      if (r.visible = w && f, r.visible && !n && (this.startingVisibleChildIndex = i, n = !0), !r.visible && n && (this.endingVisibleChildIndex = Math.min(i + 1, this.options.length - 1)), p !== r.visible ? (p ? r.emit("hide") : r.emit("show"), r.just_added && delete r.just_added) : r.just_added && (r.visible ? r.emit("show") : r.emit("hide"), delete r.just_added), !r.visible && !p && n)
        return;
    }
  ...
  applyDrag(t) {
    ...
    const e = Math.abs(this._currentScroll - this.scrollToDest), n = e > 1e3 ? 4e3 : e > 700 ? 3e3 : e > 500 ? 2e3 : e > 200 ? 1e3 : 400;
    this.scrollDuration = Math.min(this.scrollDuration, n), this.animationFrame = this.animateScroll(Date.now());
  }
  applySwipe(t) {
    ...
    const e = Math.abs(t), n = e < 10 ? 25 : e < 25 ? 30 : e < 30 ? 35 : e < 35 ? 55 : e < 40 ? 60 : e < 60 ? 65 : 80, i = t * n;
  ...
  spliceScrollItems(t, e, n = !0) {
    e = e >= 0 ? e : this.options.length;
    const i = [];
    for (let r = t; r < e; r++)
      i.push(r);
    this.removeScrollItems(i, n);
  }
  removeScrollItems(t, e = !0) {
    ...
    return t.forEach((i) => {
      ...
      const f = this.options.find((w) => w === r);
      f && (n.push(this.options.indexOf(f)), f && f.parent === this.po && this.po.removeChild(f), e && f.destroy({ children: !0 }));
    }), n.length ? (this.options = this.options.filter((i, r) => !n.includes(r)), this._currentScroll > this.maxHeight - this.__height && (this.currentScroll = this.maxHeight - this.__height), this.recalculateHeight(), this.repositionOptions(), this.adjustVisibility(null, !0), this.redraw(), !0) : !1;
  }
  findOptionAtPoint(t) {
    for (let e = this.startingVisibleChildIndex; e <= this.endingVisibleChildIndex; e++) {
      const n = this.options[e];
      if (n.visible && this._containsPoint(n, t))
        return n;
    }
    return null;
  }
  recurseChildren(t, e, n) {
    return (t.interactive || t.interactiveChildren) && this._containsPoint(t, e) && (t.interactive && n.push(t), t.interactiveChildren && t.children && t.children.forEach((i) => {
      this.recurseChildren(i, e, n);
    })), n;
  }
}
var F = { exports: {} }, J = F.exports, N;
function tt() {
  return N || (N = 1, function(m, t) {
    (function(n, i) {
      m.exports = i();
    })(J, function() {
      return (
        ...
        function(e) {
          ...
          function(e, n, i) {
            ...
            e.exports = function(p, x) {
              ...
              return params = {
                ...
                startTime: void 0,
                easing: r("linear")
              }, g.onUpdate = a("updater"), g.onEnd = a("ender"), g.start = h, g.duration = a("length"), g.stop = s, g.update = l, g.easing = o, g;
              function o(u) {
                return params.easing = r(u) || r("linear"), g;
              }
              function h(u) {
                return params.startTime = w(), typeof u == "function" && setTimeout(u), g;
              }
              function l() {
                if (params.startTime) {
                  var u = c();
              ...
              function c() {
                var u = w() - params.startTime, v = u / params.length;
                return {
                  frames: b.map(function(C, I) {
              ...
              function d() {
                return params.updater(b.map(function(u) {
                  return f.rgb(u);
                }), 1), s(), g;
              }
              function s() {
                return params.startTime = void 0, params.ender(b.map(function(u) {
                  f.rgb(u);
                }), 1), g;
              }
              function a(u) {
          ...
          function(e, n, i) {
            ...
            function f(p) {
              var x = [/InOut$/, /In$/, /Out$/], y = x.reduce(function(b, g, o) {
                var h = g.exec(p);
                return h && !b && (b = h), b;
              }, void 0);
          ...
          function(e, n, i) {
            ...
            Object.keys(f).forEach(function(s) {
              x[w.call(f[s].labels).sort().join("")] = s;
            });
            var y = {};
            function b(s, a) {
              if (!(this instanceof b))
                return new b(s, a);
              if (a && a in p && (a = null), a && !(a in f))
              ...
              if (!s)
                ...
                this.model = a || "rgb", v = f[this.model].channels;
                var C = w.call(s, 0, v);
              ...
              if (y[this.model])
                for (v = f[this.model].channels, u = 0; u < v; u++) {
                  var L = y[this.model][u];
                  L && (this.color[u] = L(this.color[u]));
                }
            ...
            b.prototype = {
              ...
              string: function(s) {
                var a = this.model in r.to ? this : this.rgb();
                a = a.round(typeof s == "number" ? s : 1);
                var u = a.valpha === 1 ? a.color : a.color.concat(this.valpha);
                return r.to[a.model](u);
              },
              percentString: function(s) {
                var a = this.rgb().round(typeof s == "number" ? s : 1), u = a.valpha === 1 ? a.color : a.color.concat(this.valpha);
              ...
              object: function() {
                for (var s = {}, a = f[this.model].channels, u = f[this.model].labels, v = 0; v < a; v++)
                  s[u[v]] = this.color[v];
              ...
              round: function(s) {
                return s = Math.max(s || 0, 0), new b(this.color.map(o(s)).concat(this.valpha), this.model);
              },
              alpha: function(s) {
                return arguments.length ? new b(this.color.concat(Math.max(0, Math.min(1, s))), this.model) : this.valpha;
              },
              // rgb
              red: h("rgb", 0, l(255)),
              green: h("rgb", 1, l(255)),
              ...
              b: h("lab", 2),
              keyword: function(s) {
                return arguments.length ? new b(s) : f[this.model].keyword(this.color);
              },
              hex: function(s) {
                return arguments.length ? new b(s) : r.to.hex(this.rgb().round().color);
              },
              rgbNumber: function() {
                var s = this.rgb().color;
              ...
              luminosity: function() {
                for (var s = this.rgb().color, a = [], u = 0; u < s.length; u++) {
                  var v = s[u] / 255;
                  a[u] = v <= 0.03928 ? v / 12.92 : Math.pow((v + 0.055) / 1.055, 2.4);
                }
                return 0.2126 * a[0] + 0.7152 * a[1] + 0.0722 * a[2];
              },
              contrast: function(s) {
                var a = this.luminosity(), u = s.luminosity();
                return a > u ? (a + 0.05) / (u + 0.05) : (u + 0.05) / (a + 0.05);
              },
              level: function(s) {
                var a = this.contrast(s);
                return a >= 7.1 ? "AAA" : a >= 4.5 ? "AA" : "";
              },
              dark: function() {
                var s = this.rgb().color, a = (s[0] * 299 + s[1] * 587 + s[2] * 114) / 1e3;
                return a < 128;
              },
              light: function() {
                return !this.dark();
              ...
              negate: function() {
                for (var s = this.rgb(), a = 0; a < 3; a++)
                  s.color[a] = 255 - s.color[a];
                return s;
              },
              lighten: function(s) {
                var a = this.hsl();
                return a.color[2] += a.color[2] * s, a;
              },
              darken: function(s) {
                var a = this.hsl();
                return a.color[2] -= a.color[2] * s, a;
              ...
              saturate: function(s) {
                var a = this.hsl();
                return a.color[1] += a.color[1] * s, a;
              },
              ...
              grayscale: function() {
                var s = this.rgb().color, a = s[0] * 0.3 + s[1] * 0.59 + s[2] * 0.11;
                return b.rgb(a, a, a);
              },
              fade: function(s) {
              ...
              rotate: function(s) {
                var a = this.hsl(), u = a.color[0];
                return u = (u + s) % 360, u = u < 0 ? 360 + u : u, a.color[0] = u, a;
              },
              mix: function(s, a) {
                var u = this.rgb(), v = s.rgb(), S = a === void 0 ? 0.5 : a, C = 2 * S - 1, I = u.alpha() - v.alpha(), O = ((C * I === -1 ? C : (C + I) / (1 + C * I)) + 1) / 2, M = 1 - O;
                return b.rgb(
                  O * u.red() + M * v.red(),
                  O * u.green() + M * v.green(),
                  O * u.blue() + M * v.blue(),
              ...
              if (p.indexOf(s) === -1) {
                ...
                b.prototype[s] = function() {
                  if (this.model === s)
                    return new b(this);
                  if (arguments.length)
                    return new b(arguments, s);
                  var u = typeof arguments[a] == "number" ? a : this.valpha;
                  return new b(c(f[this.model][s].raw(this.color)).concat(u), s);
                }, b[s] = function(u) {
                  return typeof u == "number" && (u = d(w.call(arguments), a)), new b(u, s);
                };
              }
            });
            function g(s, a) {
            ...
            function h(s, a, u) {
              return s = Array.isArray(s) ? s : [s], s.forEach(function(v) {
                ...
                var S;
                return arguments.length ? (u && (v = u(v)), S = this[s](), S.color[a] = v, S) : (S = this[s]().color[a], u && (S = u(S)), S);
              };
            }
            function l(s) {
              return function(a) {
          ...
          function(e, n, i) {
            ...
            x.get = function(g) {
              ...
              if (!g)
                return null;
              var o = /^#([a-f0-9]{3,4})$/i, h = /^#([a-f0-9]{6})([a-f0-9]{2})?$/i, l = /^rgba?\(\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/, c = /^rgba?\(\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/, d = /(\D+)/, s = [0, 0, 0, 1], a, u, v;
              if (a = g.match(h)) {
                for (v = a[2], a = a[1], u = 0; u < 3; u++) {
                  var S = u * 2;
                  s[u] = parseInt(a.slice(S, S + 2), 16);
                }
                v && (s[3] = Math.round(parseInt(v, 16) / 255 * 100) / 100);
              } else if (a = g.match(o)) {
                for (a = a[1], v = a[3], u = 0; u < 3; u++)
                  s[u] = parseInt(a[u] + a[u], 16);
                v && (s[3] = Math.round(parseInt(v + v, 16) / 255 * 100) / 100);
              } else if (a = g.match(l)) {
                for (u = 0; u < 3; u++)
                  s[u] = parseInt(a[u + 1], 0);
                a[4] && (s[3] = parseFloat(a[4]));
              } else if (a = g.match(c)) {
                for (u = 0; u < 3; u++)
                  s[u] = Math.round(parseFloat(a[u + 1]) * 2.55);
                a[4] && (s[3] = parseFloat(a[4]));
              } else return (a = g.match(d)) ? a[1] === "transparent" ? [0, 0, 0, 0] : (s = r[a[1]], s ? (s[3] = 1, s) : null) : null;
              for (u = 0; u < 3; u++)
                s[u] = y(s[u], 0, 255);
              ...
              if (h) {
                var l = parseFloat(h[4]), c = (parseFloat(h[1]) + 360) % 360, d = y(parseFloat(h[2]), 0, 100), s = y(parseFloat(h[3]), 0, 100), a = y(isNaN(l) ? 1 : l, 0, 1);
                return [c, d, s, a];
              }
              return null;
              ...
              if (h) {
                var l = parseFloat(h[4]), c = (parseFloat(h[1]) % 360 + 360) % 360, d = y(parseFloat(h[2]), 0, 100), s = y(parseFloat(h[3]), 0, 100), a = y(isNaN(l) ? 1 : l, 0, 1);
                return [c, d, s, a];
              }
              return null;
            }, x.to.hex = function() {
              var g = f(arguments);
              return "#" + b(g[0]) + b(g[1]) + b(g[2]) + (g[3] < 1 ? b(Math.round(g[3] * 255)) : "");
            }, x.to.rgb = function() {
              var g = f(arguments);
          ...
          /***/
          function(e, n, i) {
            var r = i(8), f = Array.prototype.concat, w = Array.prototype.slice, p = e.exports = function(y) {
              for (var b = [], g = 0, o = y.length; g < o; g++) {
                var h = y[g];
                r(h) ? b = f.call(b, w.call(h)) : b.push(h);
              }
              return b;
            };
            p.wrap = function(x) {
          ...
          /***/
          function(e, n, i) {
            var r = i(10), f = i(11), w = {}, p = Object.keys(r);
            function x(b) {
              var g = function(o) {
                return o == null ? o : (arguments.length > 1 && (o = Array.prototype.slice.call(arguments)), b(o));
              };
              return "conversion" in b && (g.conversion = b.conversion), g;
            }
            function y(b) {
              var g = function(o) {
                if (o == null)
            ...
            p.forEach(function(b) {
              w[b] = {}, Object.defineProperty(w[b], "channels", { value: r[b].channels }), Object.defineProperty(w[b], "labels", { value: r[b].labels });
              var g = f(b), o = Object.keys(g);
              o.forEach(function(h) {
                var l = g[h];
                w[b][h] = y(l), w[b][h].raw = x(l);
              });
            }), e.exports = w;
          },
          /* 10 */
          ...
          function(e, n, i) {
            ...
            for (var x in p)
              if (p.hasOwnProperty(x)) {
                ...
                var y = p[x].channels, b = p[x].labels;
                delete p[x].channels, delete p[x].labels, Object.defineProperty(p[x], "channels", { value: y }), Object.defineProperty(p[x], "labels", { value: b });
              }
            p.rgb.hsl = function(o) {
              var h = o[0] / 255, l = o[1] / 255, c = o[2] / 255, d = Math.min(h, l, c), s = Math.max(h, l, c), a = s - d, u, v, S;
              return s === d ? u = 0 : h === s ? u = (l - c) / a : l === s ? u = 2 + (c - h) / a : c === s && (u = 4 + (h - l) / a), u = Math.min(u * 60, 360), u < 0 && (u += 360), S = (d + s) / 2, s === d ? v = 0 : S <= 0.5 ? v = a / (s + d) : v = a / (2 - s - d), [u, v * 100, S * 100];
            }, p.rgb.hsv = function(o) {
              var h, l, c, d, s, a = o[0] / 255, u = o[1] / 255, v = o[2] / 255, S = Math.max(a, u, v), C = S - Math.min(a, u, v), I = function(O) {
                return (S - O) / 6 / C + 1 / 2;
              };
              return C === 0 ? d = s = 0 : (s = C / S, h = I(a), l = I(u), c = I(v), a === S ? d = c - l : u === S ? d = 1 / 3 + h - c : v === S && (d = 2 / 3 + l - h), d < 0 ? d += 1 : d > 1 && (d -= 1)), [
                d * 360,
                s * 100,
                S * 100
              ];
              ...
              var h = o[0] / 255, l = o[1] / 255, c = o[2] / 255, d, s, a, u;
              return u = Math.min(1 - h, 1 - l, 1 - c), d = (1 - h - u) / (1 - u) || 0, s = (1 - l - u) / (1 - u) || 0, a = (1 - c - u) / (1 - u) || 0, [d * 100, s * 100, a * 100, u * 100];
            };
            function g(o, h) {
            ...
            p.rgb.keyword = function(o) {
              ...
              var d = h * 0.4124 + l * 0.3576 + c * 0.1805, s = h * 0.2126 + l * 0.7152 + c * 0.0722, a = h * 0.0193 + l * 0.1192 + c * 0.9505;
              return [d * 100, s * 100, a * 100];
            }, p.rgb.lab = function(o) {
              var h = p.rgb.xyz(o), l = h[0], c = h[1], d = h[2], s, a, u;
              return l /= 95.047, c /= 100, d /= 108.883, l = l > 8856e-6 ? Math.pow(l, 1 / 3) : 7.787 * l + 16 / 116, c = c > 8856e-6 ? Math.pow(c, 1 / 3) : 7.787 * c + 16 / 116, d = d > 8856e-6 ? Math.pow(d, 1 / 3) : 7.787 * d + 16 / 116, s = 116 * c - 16, a = 500 * (l - c), u = 200 * (c - d), [s, a, u];
            }, p.hsl.rgb = function(o) {
              var h = o[0] / 360, l = o[1] / 100, c = o[2] / 100, d, s, a, u, v;
              if (l === 0)
                return v = c * 255, [v, v, v];
              c < 0.5 ? s = c * (1 + l) : s = c + l - c * l, d = 2 * c - s, u = [0, 0, 0];
              for (var S = 0; S < 3; S++)
                a = h + 1 / 3 * -(S - 1), a < 0 && a++, a > 1 && a--, 6 * a < 1 ? v = d + (s - d) * 6 * a : 2 * a < 1 ? v = s : 3 * a < 2 ? v = d + (s - d) * (2 / 3 - a) * 6 : v = d, u[S] = v * 255;
              return u;
            }, p.hsl.hsv = function(o) {
              var h = o[0], l = o[1] / 100, c = o[2] / 100, d = l, s = Math.max(c, 0.01), a, u;
              return c *= 2, l *= c <= 1 ? c : 2 - c, d *= s <= 1 ? s : 2 - s, u = (c + l) / 2, a = c === 0 ? 2 * d / (s + d) : 2 * l / (c + l), [h, a * 100, u * 100];
            }, p.hsv.rgb = function(o) {
              var h = o[0] / 60, l = o[1] / 100, c = o[2] / 100, d = Math.floor(h) % 6, s = h - Math.floor(h), a = 255 * c * (1 - l), u = 255 * c * (1 - l * s), v = 255 * c * (1 - l * (1 - s));
              switch (c *= 255, d) {
                case 0:
                  return [c, v, a];
                case 1:
              ...
              var h = o[0], l = o[1] / 100, c = o[2] / 100, d = Math.max(c, 0.01), s, a, u;
              return u = (2 - l) * c, s = (2 - l) * d, a = l * d, a /= s <= 1 ? s : 2 - s, a = a || 0, u /= 2, [h, a * 100, u * 100];
            }, p.hwb.rgb = function(o) {
              var h = o[0] / 360, l = o[1] / 100, c = o[2] / 100, d = l + c, s, a, u, v;
              d > 1 && (l /= d, c /= d), s = Math.floor(6 * h), a = 1 - c, u = 6 * h - s, s & 1 && (u = 1 - u), v = l + u * (a - l);
              var S, C, I;
              switch (s) {
                default:
                case 6:
              ...
              var h = o[0] / 100, l = o[1] / 100, c = o[2] / 100, d = o[3] / 100, s, a, u;
              return s = 1 - Math.min(1, h * (1 - d) + d), a = 1 - Math.min(1, l * (1 - d) + d), u = 1 - Math.min(1, c * (1 - d) + d), [s * 255, a * 255, u * 255];
            }, p.xyz.rgb = function(o) {
              var h = o[0] / 100, l = o[1] / 100, c = o[2] / 100, d, s, a;
              return d = h * 3.2406 + l * -1.5372 + c * -0.4986, s = h * -0.9689 + l * 1.8758 + c * 0.0415, a = h * 0.0557 + l * -0.204 + c * 1.057, d = d > 31308e-7 ? 1.055 * Math.pow(d, 1 / 2.4) - 0.055 : d * 12.92, s = s > 31308e-7 ? 1.055 * Math.pow(s, 1 / 2.4) - 0.055 : s * 12.92, a = a > 31308e-7 ? 1.055 * Math.pow(a, 1 / 2.4) - 0.055 : a * 12.92, d = Math.min(Math.max(0, d), 1), s = Math.min(Math.max(0, s), 1), a = Math.min(Math.max(0, a), 1), [d * 255, s * 255, a * 255];
            }, p.xyz.lab = function(o) {
              var h = o[0], l = o[1], c = o[2], d, s, a;
              return h /= 95.047, l /= 100, c /= 108.883, h = h > 8856e-6 ? Math.pow(h, 1 / 3) : 7.787 * h + 16 / 116, l = l > 8856e-6 ? Math.pow(l, 1 / 3) : 7.787 * l + 16 / 116, c = c > 8856e-6 ? Math.pow(c, 1 / 3) : 7.787 * c + 16 / 116, d = 116 * l - 16, s = 500 * (h - l), a = 200 * (l - c), [d, s, a];
            }, p.lab.xyz = function(o) {
              var h = o[0], l = o[1], c = o[2], d, s, a;
              s = (h + 16) / 116, d = l / 500 + s, a = s - c / 200;
              var u = Math.pow(s, 3), v = Math.pow(d, 3), S = Math.pow(a, 3);
              return s = u > 8856e-6 ? u : (s - 16 / 116) / 7.787, d = v > 8856e-6 ? v : (d - 16 / 116) / 7.787, a = S > 8856e-6 ? S : (a - 16 / 116) / 7.787, d *= 95.047, s *= 100, a *= 108.883, [d, s, a];
            }, p.lab.lch = function(o) {
              var h = o[0], l = o[1], c = o[2], d, s, a;
              return d = Math.atan2(c, l), s = d * 360 / 2 / Math.PI, s < 0 && (s += 360), a = Math.sqrt(l * l + c * c), [h, a, s];
            }, p.lch.lab = function(o) {
              var h = o[0], l = o[1], c = o[2], d, s, a;
              return a = c / 360 * 2 * Math.PI, d = l * Math.cos(a), s = l * Math.sin(a), [h, d, s];
              ...
              var c = parseInt(l, 16), d = c >> 16 & 255, s = c >> 8 & 255, a = c & 255;
              return [d, s, a];
            }, p.rgb.hcg = function(o) {
              var h = o[0] / 255, l = o[1] / 255, c = o[2] / 255, d = Math.max(Math.max(h, l), c), s = Math.min(Math.min(h, l), c), a = d - s, u, v;
              return a < 1 ? u = s / (1 - a) : u = 0, a <= 0 ? v = 0 : d === h ? v = (l - c) / a % 6 : d === l ? v = 2 + (c - h) / a : v = 4 + (h - l) / a + 4, v /= 6, v %= 1, [v * 360, a * 100, u * 100];
              ...
              var d = [0, 0, 0], s = h % 1 * 6, a = s % 1, u = 1 - a, v = 0;
              switch (Math.floor(s)) {
                case 0:
                  d[0] = 1, d[1] = a, d[2] = 0;
                  break;
          ...
          function(e, n, i) {
            var r = i(10);
            function f() {
              for (var y = {}, b = Object.keys(r), g = b.length, o = 0; o < g; o++)
                y[b[o]] = {
            ...
            function w(y) {
              var b = f(), g = [y];
              for (b[y].distance = 0; g.length; )
                for (var o = g.pop(), h = Object.keys(r[o]), l = h.length, c = 0; c < l; c++) {
                  var d = h[c], s = b[d];
                  s.distance === -1 && (s.distance = b[o].distance + 1, s.parent = o, g.unshift(d));
                }
              return b;
            }
            function p(y, b) {
            ...
            function x(y, b) {
              for (var g = [b[y].parent, y], o = r[b[y].parent][y], h = b[y].parent; b[h].parent; )
                g.unshift(b[h].parent), o = p(r[b[h].parent][h], o), h = b[h].parent;
              return o.conversion = g, o;
            }
            e.exports = function(y) {
              for (var b = w(y), g = {}, o = Object.keys(b), h = o.length, l = 0; l < h; l++) {
                var c = o[l], d = b[c];
                d.parent !== null && (g[c] = x(c, b));
              }
              return g;
            };
          }
...
var et = tt();
const it = /* @__PURE__ */ V(et), dt = "__pixi-dom-dynamic-texture-atlas";
var rt = /* @__PURE__ */ ((m) => (m.flexStart = "flex-start", m.flexEnd = "flex-end", m.center = "center", m.spaceBetween = "spaceBetween", m.spaceAround = "spaceAround", m.spaceEvenly = "spaceEvenly", m))(rt || {}), st = /* @__PURE__ */ ((m) => (m.row = "row", m.row_reverse = "row-reverse", m.column = "column", m.column_reverse = "column-reverse", m))(st || {}), nt = /* @__PURE__ */ ((m) => (m.nowrap = "nowrap", m.wrap = "wrap", m.wrap_reverse = "wrap-reverse", m))(nt || {}), at = /* @__PURE__ */ ((m) => (m.LINEAR = "linear", m.QUADRATIC = "quadtratic", m.CUBIC = "cubic", m.QUARTIC = "quartic", m.QUINTIC = "quintic", m.SINUSOIDAL = "sinusoidal", m.EXPONENTIAL = "exponential", m.CIRCULAR = "circular", m.ELASTIC = "elastic", m.BACK = "back", m))(at || {}), _ = /* @__PURE__ */ ((m) => (m.background = "background", m.circle_color = "circle_color", m.circle_position = "circle_position", m.label = "label", m))(_ || {});
const D = 2;
class ot extends PIXI.Container {
  constructor(t, e) {
    ...
    const n = t.borderRadius ? t.borderRadius : 50;
    if (t.borderRadius = n, this.computedBorderRadius = t.borderRadius / 100 * t.height, this.backgroundGraphic.drawRoundedRect(0, 0, t.width, t.height, this.computedBorderRadius), this.addChild(this.backgroundGraphic), t.labelOptions) {
      const { fontName: i, onLabel: r, offLabel: f, onColor: w, offColor: p } = t.labelOptions;
      ...
      this.offText.y = y / 2;
      const b = t.width / 2 - this.onText.width;
      if (b < 0)
        throw new Error("Label for on text was too long");
      if (this.onText.x = D + b / 2, this.onText.tint = w, t.height - this.onText.height < 0)
        throw new Error("Label font is too large to fit within height of toggle, either increase height or use smaller font");
  ...
  midAnimationToggleUpdate(t, e) {
    const n = this.toggleCircleTravelDistance * e, { exclude: i } = this.options.animationOptions;
    if (this.usingLabels && (!i || !i.includes(_.label)) && (this.activeTextLabel.visible = !0, this.inactiveTextLabel.visible = !0, this.inactiveTextLabel.alpha = 1 - e, this.activeTextLabel.alpha = e), this.backgroundColorsArrayIndex !== null) {
      ...
      this.backgroundGraphic.beginFill(H(t[this.backgroundColorsArrayIndex].hex())), this.backgroundGraphic.drawRoundedRect(0, 0, this.options.width, this.options.height, this.computedBorderRadius), this.backgroundGraphic.endFill();
    }
    (!i || !i.includes(_.circle_position)) && (this.toggled ? this.circleGraphic.x = this.travelToX + n : this.circleGraphic.x = this.travelToX - n), this.circleColorsArrayIndex !== null && (this.circleGraphic.clear(), this.circleGraphic.beginFill(H(t[this.circleColorsArrayIndex].hex())), this.circleGraphic.drawCircle(this.circleRadius, this.circleRadius, this.circleRadius), this.circleGraphic.endFill());
  }
  animatedToggleUpdate() {
    const t = [], e = [], { exclude: n } = this.options.animationOptions;
    (!n || !n.includes(_.background)) && (t.push(PIXI.utils.hex2string(this.activeBackgroundColor)), e.push(PIXI.utils.hex2string(this.inactiveBackgroundColor)), this.backgroundColorsArrayIndex = 0), (!n || !n.includes(_.circle_color)) && (t.push(PIXI.utils.hex2string(this.activeCircleColor)), e.push(PIXI.utils.hex2string(this.inactiveCircleColor)), this.circleColorsArrayIndex = t.length - 1), this.tween = new it(e, t).duration(this.options.animationOptions.duration).easing(this.options.animationOptions.type).onUpdate(this.midAnimationToggleUpdate.bind(this)).onEnd(this.staticToggleUpdate.bind(this)).start(this.animateToggle.bind(this));
  }
  staticToggleUpdate() {
    if (this.backgroundGraphic.clear(), this.options.hasOwnProperty("backgroundOutline")) {
    ...
    let t, e, n;
    this._toggled ? (n = this.options.onBackgroundColor, t = this.options.width - this.circleGraphic.width - D, e = this.options.onCircleColor, this._showOnText()) : (n = this.options.offBackgroundColor, t = 0 + D, e = this.options.offCircleColor, this._showOffText()), this.backgroundGraphic.beginFill(n), this.backgroundGraphic.drawRoundedRect(0, 0, this.options.width, this.options.height, this.computedBorderRadius), this.backgroundGraphic.endFill(), this.circleGraphic.clear(), this.circleGraphic.beginFill(e), this.circleGraphic.drawCircle(this.circleRadius, this.circleRadius, this.circleRadius), this.circleGraphic.endFill(), this.circleGraphic.x = t;
  }
  _showOnText() {
...
class ht extends T {
  ...
  redrawBg() {
    let { backgroundColor: t, borderRadius: e, borderColor: n, borderWidth: i, width: r, height: f, backgroundTexture: w, backgroundOpacity: p, borderOpacity: x } = this.currentStyleState;
    if (t || t == 0) {
      if (this.bgGraphic ? this.bgGraphic.clear() : this.bgGraphic = new PIXI.Graphics(), this.bgGraphic.parent || this.addChild(this.bgGraphic), p = p || p == 0 ? p : 1, this.bgGraphic.beginFill(t, p), i && (x = x || x == 0 ? x : 1, this.bgGraphic.lineStyle(i, n, x)), e) {
        const y = e / 100 * f;
    ...
    w && (this.bgSprite || (this.bgSprite = new PIXI.Sprite()), this.bgSprite.parent || this.addChild(this.bgGraphic), this.bgSprite.texture = w, this.bgSprite.x = r / 2 - this.bgSprite.x / 2, this.bgSprite.y = f / 2 - this.bgSprite.y / 2), this.hitArea = new PIXI.Rectangle(0, 0, r, f);
  }
  clear() {
...
class lt extends PIXI.Container {
  constructor(t) {
    ...
    this.circleGraphic.x = e * this.options.width, this.redrawCircle(), this.redrawBar(), this.circleGraphic.on("pointerover", (n) => {
    ...
    }), this.circleGraphic.on("pointerdown", (n) => {
      this.resolvedScale = null, this.resolveScale(), this.isDragging = !0, this.lastX = n.data.global.x, this.redrawCircle();
      ...
      this.isDragging && (this.resolvedScale = null, this.isDragging = !1, this.redrawCircle());
    }), this.circleGraphic.on("pointermove", (n) => {
      if (!this.isDragging) return;
      let i = n.data.global.x - this.lastX;
      const r = this.options.preventScaleAdjustment ? 1 : this.resolveScale().x;
      if (i *= r, i < 0 && n.data.global.x * r < this.x && this.circleGraphic.x === 0 || i > 0 && n.data.global.x * r > this.options.width && this.circleGraphic.x === this.options.width) return;
      this.lastX = n.data.global.x;
  ...
  resolveScale() {
    ...
    let t = 1 / this.scale.x, e = 1 / this.scale.y, n = this.parent;
    for (; n; )
      t /= n.scale.x, e /= n.scale.y, n = n.parent;
    return this.resolvedScale = { x: t, y: e };
  }
  calculateValue() {
    const { maxValue: t, minValue: e, width: n } = this.options, i = this.circleGraphic.x / n;
    return ct(e, t, i);
  }
  redrawCircle() {
    var w, p, x, y, b, g, o, h, l, c, d, s;
    this.circleGraphic.clear();
    let t = this.options.circleOpacity || 1;
    this.isDragging && ((w = this.options.down) != null && w.circleOpacity) ? t = this.options.down.circleOpacity : this.isHovered && ((p = this.options.hover) != null && p.circleOpacity) && (t = this.options.hover.circleOpacity);
    ...
    let n = this.options.circleColor;
    this.isDragging && ((b = this.options.down) != null && b.circleColor) ? n = this.options.down.circleColor : this.isHovered && ((g = this.options.hover) != null && g.circleColor) && (n = this.options.hover.circleColor);
    let i = 0;
    ...
    this.isDragging && ((d = this.options.down) != null && d.circleOutlineOpacity) ? f = this.options.down.circleOutlineOpacity : this.isHovered && ((s = this.options.hover) != null && s.circleOutlineOpacity) && (f = this.options.hover.circleOutlineOpacity), this.circleGraphic.lineStyle(i, r, f), this.circleGraphic.beginFill(n, t), this.circleGraphic.drawCircle(0, e, e), this.circleGraphic.endFill(), G(this.circleGraphic, { axis: "y", parent: { height: this.options.height } });
  }
  redrawBar() {
    const t = this.circleGraphic.x, e = this.options.width - t;
    this.backgroundGraphic.clear();
    const n = this.options.opacity || 1;
    this.backgroundGraphic.beginFill(this.options.activeColor, n), this.backgroundGraphic.drawRect(0, 0, t, this.options.height), this.backgroundGraphic.endFill(), this.backgroundGraphic.beginFill(this.options.inactiveColor, n), this.backgroundGraphic.drawRect(t, 0, e, this.options.height), this.backgroundGraphic.endFill();
  }
  offChange(t) {
...
PIXI !== void 0 && (PIXI.Slider = PIXI.Slider || lt, PIXI.Toggle = PIXI.Toggle || ot, PIXI.TextField = PIXI.TextField || q, PIXI.Element = PIXI.Element || T, PIXI.ScrollBar = PIXI.ScrollBar || z, PIXI.ScrollList = PIXI.ScrollList || Z, PIXI.Button = PIXI.Button || ht, PIXI.utils && !PIXI.utils.string2hex && (PIXI.utils.string2hex = H), PIXI.utils.centerObject = G);
export {
  at as AnimationType,
  ht as Button,
  st as FlexDirection,
